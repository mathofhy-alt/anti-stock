export const MONEY_LONGTAIL_DATA = {
    ...
    "us-stocks": {
        ...
        "joint-account-benefit": { commercialIntent: "high", tags: ["tax", "strategy"], title: "부부 공동 명의 주식 계좌 장단점 및 절세 효과", description: "양도세 기본공제 500만원 받기. 증여세 신고와 건보료 문제는?", h1: "부부 공동 명의, 무조건 유리할까?", intro: ["양도소득세 250만 원 공제를 각각 받으면 총 500만 원까지 비과세됩니다."], sections: [{ h2: "장점", content: "수익 실현 시 양도차익을 분산시켜 누진세율을 피할 수 있습니다." }, { h2: "단점", content: "소득 발생으로 인한 피부양자 자격 박탈 가능성을 체크해야 합니다." }], faq: [{ q: "타사 대체로 옮길 수 있나요?", a: "가능하지만 증여세 신고가 선행되어야 합니다." }] },
        "tax-loss-harvesting-timing": { commercialIntent: "high", tags: ["tax", "strategy"], title: "절세 매매(Tax Loss Harvesting) 12월 매도 타이밍", description: "손실 확정으로 양도세 줄이는 법. 결제일(T+3) 기준 연말 데드라인.", h1: "손실도 자산이다: 절세 매매", intro: ["이익이 난 종목의 세금을 줄이려면 손실 난 종목을 팔아 이익을 상계해야 합니다."], sections: [{ h2: "주의할 점", content: "매도 후 재매수 시 워시세일 룰(미국 거주자)이나 수수료를 고려해야 합니다." }], faq: [{ q: "언제까지 팔아야 하나요?", a: "반드시 연말 결제일(보통 12월 26~27일) 전에 체결되어야 합니다." }] },
        "stock-collateral-loan": { commercialIntent: "high", tags: ["loan", "leverage"], title: "해외주식 담보 대출 금리 비교 및 리스크", description: "급전 필요할 때 주식 팔지 마세요. 키움, 토스 등 담보 대출 금리.", h1: "주식 담보 대출 가이드", intro: ["우량주를 담보로 현금을 빌릴 수 있습니다. 매도 후 재매수보다 유리할 수 있습니다."], sections: [{ h2: "유지 비율", content: "담보 유지 비율(보통 140%) 아래로 떨어지면 반대매매 당할 수 있습니다." }], faq: [{ q: "모든 종목이 되나요?", a: "S&P500 등 우량주만 가능하며 종목별로 한도가 다릅니다." }] },
        "pre-market-limit-order": { commercialIntent: "mid", tags: ["trading", "guide"], title: "프리마켓 매수: 지정가(Limit) 주문만 되는 이유", description: "장전 거래 체결 안 되는 원인. 시장가 주문 불가와 호가 공백.", h1: "프리마켓 거래의 정석", intro: ["변동성이 큰 프리마켓에서는 투자자 보호를 위해 대부분 지정가 주문만 허용합니다."], sections: [{ h2: "체결 팁", content: "매도 호가보다 약간 높게 지정가를 넣으면 즉시 체결될 확률이 높습니다." }], faq: [{ q: "수수료가 더 비싼가요?", a: "증권사마다 다르지만 보통 정규장과 동일합니다." }] },
        "after-hours-volatility": { commercialIntent: "high", tags: ["trading", "warning"], title: "애프터마켓(시간외) 폭락 시 대처법", description: "실적 쇼크로 -20%. 다음 날 정규장까지 기다려야 할까?", h1: "공포의 애프터마켓 생존법", intro: ["유동성이 적어 적은 물량에도 주가가 요동칩니다. 섣부른 추격 매수는 위험합니다."], sections: [{ h2: "가짜 하락(Fake Drop)", content: "일시적인 수급 공백으로 인한 하락인지 실제 악재인지 뉴스 체크가 필수입니다." }], faq: [{ q: "24시간 거래 되나요?", a: "대부분의 증권사가 주간 거래를 지원하지만 24시간 내내 활발하진 않습니다." }] },
        "circuit-breaker-rule": { commercialIntent: "mid", tags: ["term", "panic"], title: "미국 주식 서킷브레이커(Circuit Breaker) 발동 조건", description: "지수가 7% 빠지면 거래 정지. 1, 2, 3단계별 발동 기준.", h1: "시장이 멈추는 순간: 서킷브레이커", intro: ["패닉 셀링을 막기 위한 안전장치입니다. S&P500 지수가 기준입니다."], sections: [{ h2: "발동 시 효과", content: "15분간 모든 주식 거래가 중단되며, 냉각기를 가집니다." }], faq: [{ q: "개별 종목도 걸리나요?", a: "개별 종목은 변동성 위화 장치(LULD)가 따로 작동합니다." }] },
        "spin-off-tax": { commercialIntent: "high", tags: ["tax", "event"], title: "스핀오프(인적분할) 받은 주식의 세금 계산법", description: "AT&T, GE 분할 사례. 취득가액 배분과 양도세 폭탄 피하기.", h1: "공짜 주식의 세금 함정", intro: ["기업 분할로 받은 주식은 취득가가 0원이 아닙니다. 기존 주식 평단가에서 안분해야 합니다."], sections: [{ h2: "수정 취득가", content: "증권사 시스템 오류로 취득가가 0으로 잡히면 세금을 과다 납부할 수 있으니 확인해야 합니다." }], faq: [{ q: "팔아야 세금 내나요?", a: "네, 분할 시점에는 과세되지 않고 매도 시 양도세가 발생합니다." }] },
        "ma-cash-deal-tax": { commercialIntent: "high", tags: ["tax", "event"], title: "기업 인수합병(M&A) 현금 청산 시 양도소득세", description: "내 주식이 강제 매도됐다? 현금 인수 시 세금 자동 부과.", h1: "M&A와 강제 세금", intro: ["현금 인수(Cash Deal) 방식은 주주의 의사와 상관없이 주식이 팔리고 현금이 입금됩니다."], sections: [{ h2: "세금 납부", content: "이익이 났다면 다음 해 5월에 양도소득세를 신고해야 합니다." }], faq: [{ q: "손실이면요?", a: "손실 확정되므로 다른 이익과 통산하여 절세에 활용 가능합니다." }] },
        "rights-offering-participation": { commercialIntent: "mid", tags: ["event", "action"], title: "유상증자 신주인수권(Rights) 매매 및 청약 방법", description: "계좌에 생긴 R 종목. 헐값에 팔까, 더 사서 물타기 할까?", h1: "유상증자 기회 활용하기", intro: ["신주인수권을 행사하면 할인된 가격에 주식을 더 살 수 있습니다."], sections: [{ h2: "권리 매도", content: "증자에 참여하기 싫다면 신주인수권 자체를 시장에 팔아 현금화할 수 있습니다." }], faq: [{ q: "방치하면 어떻게 되나요?", a: "기간 내 행사하지 않으면 소멸되어 0원이 됩니다. 반드시 처리해야 합니다." }] },
        "otc-market-fee": { commercialIntent: "high", tags: ["fee", "risk"], title: "OTC(장외시장) 주식 거래 수수료와 위험성", description: "루이비통, 닌텐도 등 비상장된 우량주 거래 팁. 살인적인 최소 수수료.", h1: "OTC 마켓 가이드", intro: ["나스닥에 없는 글로벌 기업들이 거래되는 시장입니다. 하지만 비용이 비쌀 수 있습니다."], sections: [{ h2: "수수료 주의", content: "일부 증권사는 건당 20달러 이상의 최소 수수료를 부과합니다." }], faq: [{ q: "상폐된 종목도 있나요?", a: "네, 상장 폐지된 기업들이 OTC로 내려와 거래되기도 합니다." }] },
        "adr-custody-fee": { commercialIntent: "mid", tags: ["fee", "tax"], title: "ADR(주식예탁증서) 보관 수수료 확인법", description: "TSM, 알리바바 배당금에서 돈이 빠져나간다? ADR 수수료의 진실.", h1: "숨겨진 비용: ADR 수수료", intro: ["해외 기업을 미국 증시에서 사고팔게 해주는 대가로 보관료를 징수합니다."], sections: [{ h2: "징수 주기", content: "보통 1년에 한 번 또는 분기별로 주당 0.02~0.05달러 정도가 빠져나갑니다." }], faq: [{ q: "안 내는 법 없나요?", a: "없습니다. ADR을 보유하는 한 피할 수 없는 비용입니다." }] },
        "dividend-tax-reclaim": { commercialIntent: "high", tags: ["tax", "refund"], title: "해외주식 배당소득세 과오납 환급(Tax Reclaim)", description: "프랑스, 스위스 주식 세금 30% 떼였다면? 차액 돌려받는 법.", h1: "낸 세금 돌려받기: Tax Reclaim", intro: ["제한세율보다 많이 징수된 세금을 해당국 국세청에 청구해 돌려받을 수 있습니다."], sections: [{ h2: "실익 따지기", content: "절차가 복잡하고 수수료가 들어 소액 주주는 실익이 없을 수 있습니다." }], faq: [{ q: "증권사가 해주나요?", a: "일부 대형 증권사에서 대행 서비스를 제공합니다." }] },
        "options-tax-rate": { commercialIntent: "high", tags: ["tax", "options"], title: "미국 주식 옵션 거래 양도소득세 (11%)", description: "주식(22%)과 다르다. 손익 통산 불가 원칙과 신고 방법.", h1: "옵션 세금 완전 정복", intro: ["옵션은 파생상품이라 주식과 세금 체계가 다릅니다."], sections: [{ h2: "세율과 공제", content: "11% 세율이 적용되며, 주식과 별도로 연 250만 원 기본공제가 됩니다." }], faq: [{ q: "합산 신고 되나요?", a: "아닙니다. 주식 양도세와 별건으로 계산됩니다." }] }
    },
    // ==============================================================================
    ...
    "etf": {
        ...
        "qqq-vs-qqqm": { commercialIntent: "mid", tags: ["etf", "comparison"], title: "QQQ vs QQQM: 장기 투자자라면 무조건 갈아타야 할까?", description: "수수료 0.20% vs 0.15%. 동일한 나스닥100 지수 추종 ETF 비교.", h1: "형보다 나은 아우: QQQM", intro: ["같은 물건이라면 싸게 사는 게 이득입니다. QQQM은 QQQ와 똑같지만 수수료가 쌉니다."], sections: [{ h2: "유동성 차이", content: "QQQ가 거래량은 압도적이지만, 장기 보유 목적이라면 QQQM의 적은 거래량은 문제되지 않습니다." }], faq: [{ q: "배당도 같나요?", a: "네, 기초 자산이 동일하므로 배당 수익률도 거의 같습니다." }] },
        "soxl-soxs-risk": { commercialIntent: "high", tags: ["etf", "leverage", "warning"], title: "반도체 3배 레버리지(SOXL)와 인버스(SOXS)의 위험성", description: "하루 30% 등락. 횡보장에서 계좌 녹는 음의 복리 효과 주의.", h1: "야수의 심장: SOXL 투자", intro: ["상승장에선 최고의 수익을 주지만, 하락장에선 회복 불가능한 손실을 안겨줍니다."], sections: [{ h2: "장기 투자 금물", content: "변동성 끌림 현상으로 인해 지수가 제자리로 와도 내 돈은 줄어들어 있습니다." }], faq: [{ q: "물타기 해도 되나요?", a: "추세가 확실할 때만 해야 하며, 하락 추세엔 지옥 끝까지 갈 수 있습니다." }] },
        "xlv-vht-healthcare": { commercialIntent: "mid", tags: ["etf", "healthcare"], title: "헬스케어 ETF 비교: XLV vs VHT (노령화 수혜)", description: "일라이릴리, 유나이티드헬스. 제약 바이오 대장주를 한 번에.", h1: "백세 시대 필수재: 헬스케어", intro: ["경기 방어주이면서 비만 치료제 등 성장 모멘텀도 확실합니다."], sections: [{ h2: "종목 수 차이", content: "VHT가 중소형주까지 포함해 더 넓은 범위에 투자합니다." }], faq: [{ q: "수수료는?", a: "VHT가 0.04%로 XLV보다 저렴합니다." }] },
        "xlf-financial-sector": { commercialIntent: "mid", tags: ["etf", "financial"], title: "금융주 ETF (XLF) 금리 인상기와 침체기의 투자법", description: "JP모건, 비자, 버크셔해서웨이. 은행 위기와 실적 시즌 전략.", h1: "돈이 모이는 곳: 금융주 XLF", intro: ["금리가 오르면 예대마진으로 웃고, 경기가 좋으면 소비 증가로 웃습니다."], sections: [{ h2: "버핏효과", content: "버크셔 해서웨이가 주요 비중을 차지해 간접 투자 효과가 있습니다." }], faq: [{ q: "배당률은?", a: "약 1.5~2% 수준으로 생각보다 높지 않지만 자사주 매입이 활발합니다." }] },
        "dbc-commodity-hedge": { commercialIntent: "mid", tags: ["etf", "commodity"], title: "원자재 ETF (DBC) 인플레이션 헷지 효과", description: "기름, 금, 구리, 옥수수. 주식 채권 다 떨어질 때 오르는 자산.", h1: "물가 상승 방어: 원자재 ETF", intro: ["인플레이션이 오면 현금 가치는 떨어지지만 원자재 가격은 오릅니다."], sections: [{ h2: "K-1 세금 양식", content: "파트너십 구조라 세금 신고가 복잡할 수 있습니다. PDBC(No K-1)를 대안으로 추천합니다." }], faq: [{ q: "장투 가능한가요?", a: "아닙니다. 원자재는 사이클이 있어 타이밍 매매가 필수입니다." }] },
        "ibit-bitcoin-etf": { commercialIntent: "high", tags: ["etf", "crypto"], title: "비트코인 현물 ETF (IBIT, FBTC) 수수료와 세금", description: "블랙록 vs 피델리티. 코인 거래소보다 ETF가 유리한 점은?", h1: "주식 계좌로 비트코인 사기", intro: ["해킹 위험 없이 제도권에서 비트코인을 보유할 수 있습니다."], sections: [{ h2: "세금 불리", content: "현재 한국에서 코인 직접 투자는 비과세(유예)지만, ETF는 해외주식 양도세 22%를 냅니다." }], faq: [{ q: "개인 지갑 출금 되나요?", a: "안 됩니다. 현금 정산 방식입니다." }] },
        "ethe-ethereum-staking": { commercialIntent: "high", tags: ["etf", "crypto"], title: "이더리움 ETF와 스테이킹 수익률 이슈", description: "ETF로 사면 이자(Staking Rewards)를 못 받는다? 연 3% 손해의 진실.", h1: "이더리움 ETF의 한계", intro: ["현물 ETF는 규제로 인해 스테이킹을 할 수 없어 코인 개수가 늘어나지 않습니다."], sections: [{ h2: "비용 비교", content: "장기 보유 시 스테이킹 보상을 못 받는 기회비용이 큽니다." }], faq: [{ q: "그럼에도 사는 이유는?", a: "보관의 편의성과 접근성 때문입니다." }] },
        "nifty50-india-growth": { commercialIntent: "mid", tags: ["etf", "india"], title: "인도 Nifty50 ETF (INDY, INDA) 투자 포인트", description: "포스트 차이나 인도. 14억 인구의 내수 시장 성장성.", h1: "넥스트 차이나: 인도 ETF", intro: ["젊은 인구와 고성장 GDP. 전 세계 자금이 인도로 몰리고 있습니다."], sections: [{ h2: "고평가 논란", content: "인도 주식은 항상 비싸게 거래되는 편입니다. 조정 시 매수 기회입니다." }], faq: [{ q: "개별 종목은 못 사나요?", a: "외국인 규제로 인해 ETF 투자가 가장 현실적인 방법입니다." }] },
        "vnm-vietnam-potential": { commercialIntent: "low", tags: ["etf", "vietnam"], title: "베트남 ETF (VNM) 투자와 프론티어 마켓", description: "삼성전자 생산 기지. 10년 뒤를 보고 투자하는 프론티어 국가.", h1: "아시아의 용: 베트남 VNM", intro: ["제조업 기지가 중국에서 베트남으로 이동하고 있습니다."], sections: [{ h2: "금융/부동산 편중", content: "지수 구성이 은행과 부동산에 쏠려 있어 정부 정책 리스크가 큽니다." }], faq: [{ q: "환율 위험은?", a: "동화 가치는 달러 강세 시 약세를 보일 수 있습니다." }] },
        "luxury-etf-glux": { commercialIntent: "mid", tags: ["etf", "luxury"], title: "명품 ETF (GLUX, LUXU) 경기 불황 방어주", description: "LVMH, 에르메스. 가격 전가력이 강한 럭셔리 섹터.", h1: "불황을 모르는 명품 주식", intro: ["부자들의 소비는 줄지 않습니다. 인플레이션 시기에도 마진을 유지합니다."], sections: [{ h2: "유럽 중심", content: "주요 명품 기업이 유럽에 있어 미국 상장 ETF로는 순수 투자가 어려울 수 있습니다." }], faq: [{ q: "테슬라도 명품인가요?", a: "일부 럭셔리 ETF에 포트폴리오로 포함되기도 합니다." }] },
        "pez-media-etf": { commercialIntent: "low", tags: ["etf", "media"], title: "미디어 & 엔터테인먼트 ETF (PEZ) 콘텐츠의 힘", description: "넷플릭스, 디즈니, 스포티파이. 스트리밍 전쟁의 승자.", h1: "K-콘텐츠와 미국 미디어", intro: ["플랫폼 경쟁이 치열하지만 1등 기업은 가격 인상을 주도합니다."], sections: [{ h2: "경기 민감도", content: "구독 서비스는 불황에 해지 1순위일 수 있어 경기 침체 시 주의해야 합니다." }], faq: [{ q: "게임주도 있나요?", a: "일부 포함되지만 게임 전용 ETF(ESPO)가 따로 있습니다." }] },
        "ita-defense-ranking": { commercialIntent: "high", tags: ["etf", "defense"], title: "미국 방산 ETF (ITA, XAR, PPA) 순위 비교", description: "지정학적 리스크 헷지. 록히드마틴, 레이시온 비중 분석.", h1: "전쟁과 평화: 방산 ETF", intro: ["세계 곳곳의 분쟁으로 방산 업체의 수주 잔고는 역대 최고입니다."], sections: [{ h2: "보잉 리스크", content: "ITA는 보잉 비중이 높아 민항기 이슈에 주가가 흔들릴 수 있습니다." }], faq: [{ q: "우주 항공도 포함?", a: "네, 방산 기술이 곧 우주 기술이라 함께 투자됩니다." }] },
        "icln-clean-energy": { commercialIntent: "mid", tags: ["etf", "energy"], title: "친환경 ETF (ICLN) 금리 인하 최대 수혜주", description: "태양광, 풍력. 바이든 정책과 금리의 상관관계.", h1: "금리에 우는 친환경주", intro: ["대규모 대출이 필요한 프로젝트가 많아 금리가 내리면 수익성이 급증합니다."], sections: [{ h2: "중국의 저가 공세", content: "태양광 패널 등 하드웨어는 중국산 초저가 경쟁으로 수익성이 악화되었습니다." }], faq: [{ q: "트럼프 당선되면?", a: "보조금 축소 우려로 단기적인 악재가 될 수 있습니다." }] }
    },
    // ==============================================================================
    ...
    "dividend": {
        ...
        "dividend-aristocrats-list": { commercialIntent: "high", tags: ["dividend", "list"], title: "2025 배당 귀족(Dividend Aristocrats) 리스트 TOP 10", description: "S&P500 기업 중 25년 연속 배당 인상. 경기 침체 방어주.", h1: "배당 귀족주 투자 가이드", intro: ["안정적인 현금 흐름을 원한다면 배당 귀족이 정답입니다. NOBL ETF의 주요 구성 종목입니다."], sections: [{ h2: "선정 기준", content: "S&P500 포함, 25년 이상 연속 증액, 시가총액/유동성 기준을 충족해야 합니다." }], faq: [{ q: "배당률이 높은가요?", a: "보통 2~3%대로 아주 높진 않지만 성장성이 뒷받침됩니다." }] },
        "pff-preferred-stock": { commercialIntent: "mid", tags: ["etf", "dividend"], title: "우선주 ETF (PFF) 월배당 매력과 금리 리스크", description: "주식과 채권의 중간. 은행 우선주 투자로 연 6% 배당 받기.", h1: "파킹 통장 대안: PFF", intro: ["주가 변동이 적고 배당을 꼬박꼬박 줍니다. 금리가 오르면 주가가 떨어지는 단점이 있습니다."], sections: [{ h2: "금융 위기 취약", content: "은행들이 발행한 우선주 비중이 높아 금융 시스템 위기 시 급락할 수 있습니다." }], faq: [{ q: "배당 성장하나요?", a: "아닙니다. 채권처럼 고정 배당을 줍니다." }] },
        "arcc-bdc-yield": { commercialIntent: "high", tags: ["stock", "dividend"], title: "배당률 10% BDC 대장주: 아레스 캐피탈(ARCC)", description: "중소기업 대출로 돈 버는 회사. 고금리 시대의 고배당주.", h1: "월가의 사채업자? ARCC 분석", intro: ["BDC(사업개발회사) 중 시총 1위로 가장 안정적입니다. 이익의 90%를 배당합니다."], sections: [{ h2: "변동 금리 수혜", content: "대출 자산이 변동 금리라 금리가 높을수록 이익이 커집니다." }], faq: [{ q: "경기 침체 오면?", a: "돈 빌려간 중소기업이 망하면 손실을 입을 수 있습니다." }] },
        "reit-sector-compare": { commercialIntent: "mid", tags: ["reit", "sector"], title: "리츠 섹터별 비교: 데이터센터(EQIX) vs 통신타워(AMT)", description: "건물주 말고 디지털 인프라 주인 되기. 성장형 리츠 추천.", h1: "AI 시대의 부동산 리츠", intro: ["오피스 리츠는 지고 데이터센터, 통신 타워 리츠가 뜹니다."], sections: [{ h2: "EQIX vs AMT", content: "EQIX는 데이터센터 임대, AMT는 5G 타워 임대로 둘 다 4차 산업 핵심 인프라입니다." }], faq: [{ q: "배당률은?", a: "일반 리츠보다 낮은 2~3%대지만 주가 상승폭이 큽니다." }] },
        "vig-dividend-growth": { commercialIntent: "mid", tags: ["etf", "dividend"], title: "VIG: 10년 이상 배당 성장한 기업에 투자하기", description: "마이크로소프트, 비자. 당장의 배당보다 미래의 배당을 산다.", h1: "성장하는 배당주 VIG", intro: ["배당 수익률 함정을 피하고 재무가 건전한(배당을 늘릴 수 있는) 기업만 담습니다."], sections: [{ h2: "기술주 비중", content: "SCHD와 달리 기술주 비중이 높아 상승장에서도 소외되지 않습니다." }], faq: [{ q: "배당률이 너무 낮은데?", a: "시가배당률은 낮지만 10년 뒤의 'Yield on Cost'는 놀라울 정도로 높을 것입니다." }] },
        "covered-call-tltw": { commercialIntent: "high", tags: ["etf", "bond"], title: "채권 커버드콜 TLTW: 국채 상승과 월배당을 동시에?", description: "TLT에 콜옵션 매도. 연 15% 분배금의 비밀.", h1: "채권형 슈드? TLTW 분석", intro: ["국채 ETF인 TLT를 기초로 커버드콜 전략을 씁니다. 금리 횡보기에 유리합니다."], sections: [{ h2: "상방 제한", content: "금리가 급락해 채권값이 폭등할 때 상승분이 제한됩니다." }], faq: [{ q: "원금 보장 되나요?", a: "아닙니다. 채권 가격 하락 시 원금도 같이 줄어듭니다." }] },
        "hyg-junk-bond": { commercialIntent: "mid", tags: ["etf", "bond"], title: "하이일드 채권 ETF (HYG, JNK) 위험과 수익", description: "투기 등급 회사채. 고수익 뒤에 숨겨진 부도 리스크.", h1: "위험을 사는 투자: 정크 본드", intro: ["신용 등급이 낮은 기업의 채권입니다. 주식처럼 움직입니다."], sections: [{ h2: "경기 침체 시", content: "기업 부도율이 증가하면 하이일드 채권 가격도 급락합니다." }], faq: [{ q: "월배당인가요?", a: "네, 매월 높은 이자를 지급합니다." }] },
        "mub-municipal-bond": { commercialIntent: "high", tags: ["etf", "tax"], title: "미국 지방채 ETF (MUB) 세금 혜택 (한국인 X)", description: "미국인에겐 비과세, 한국인에겐? 안정적인 지방 정부 채권.", h1: "미국 지방채(Munis) 투자", intro: ["미국 거주자에겐 연방 소득세 면제 혜택이 있지만 한국인은 없습니다."], sections: [{ h2: "안정성", content: "지방 정부 파산은 매우 드물어 국채 다음으로 안전합니다." }], faq: [{ q: "수익률은?", a: "비과세 메리트 때문에 표면 금리는 국채보다 낮습니다." }] },
        "dividend-capture-fail": { commercialIntent: "mid", tags: ["strategy", "dividend"], title: "배당 캡처(Dividend Capture) 전략 실패 이유", description: "배당락일에 주가 하락폭이 배당금보다 크다면? 세금 계산의 중요성.", h1: "배당 단타가 어려운 이유", intro: ["배당락일 시초가는 이론적으로 배당금만큼 빠져서 시작합니다."], sections: [{ h2: "세금 누수", content: "배당금 15% 세금을 내고 나면, 주가 하락분만큼 손해를 볼 수 있습니다." }], faq: [{ q: "성공하려면?", a: "주가가 빠르게 회복하는 강세장에서만 유효한 전략입니다." }] },
        "monthly-dividend-o-compound": { commercialIntent: "high", tags: ["stock", "dividend"], title: "리얼티인컴(O) 월배당 재투자의 복리 효과", description: "매달 받은 배당으로 1주 더 사기. 10년 뒤 주식 수 변화.", h1: "눈덩이 굴리기: 리얼티인컴", intro: ["월배당은 복리 주기가 짧아 재투자 효과가 극대화됩니다."], sections: [{ h2: "배당금 사용 금지", content: "배당을 생활비로 쓰지 않고 재투자할 때 진정한 복리가 완성됩니다." }], faq: [{ q: "배당 컷 위험은?", a: "수십 년간 배당을 늘려온 배당 귀족이라 가능성이 낮습니다." }] },
        "schd-simulation-10y": { commercialIntent: "high", tags: ["etf", "dividend"], title: "SCHD 매월 100만원 적립 시 10년 뒤 자산", description: "배당 성장률 10% 가정 시뮬레이션. 은퇴 자금 마련.", h1: "노후 준비의 정석 SCHD", intro: ["당장의 커피값보다 10년 뒤의 생활비를 위해 투자하세요."], sections: [{ h2: "Total Return", content: "배당 재투자 시 S&P500에 버금가는 수익률을 보여왔습니다." }], faq: [{ q: "폭락장 방어력은?", a: "가치주 위주라 나스닥보다 하락폭이 적습니다." }] }
    },
    // ==============================================================================
    // 4. 전망 (Forecast) - Market Outlook, Trends, Macro
    // ==============================================================================
    "forecast": {
        "market-outlook-2025": { commercialIntent: "high", tags: ["forecast", "macro"], title: "2025년 미국 증시 전망: 골디락스 vs 침체", description: "월가 IB들의 S&P500 목표가. 강세장은 지속될 것인가.", h1: "2025 증시, 상방은 열려있다?", intro: ["AI 생산성 혁명으로 기업 이익이 늘어나는 골디락스 시나리오가 우세합니다."], sections: [{ h2: "리스크 요인", content: "소비 둔화와 상업용 부동산 부실이 잠재적 뇌관입니다." }], faq: [{ q: "현금 비중은?", a: "타이밍을 재기보다 항상 일정 비중 투자를 유지하는 것이 좋습니다." }] },
        "rate-cut-beneficiary": { commercialIntent: "high", tags: ["forecast", "fed"], title: "금리 인하 시기 수혜주 섹터 TOP 3", description: "바이오, 중소형주(러셀2000), 리츠. 고금리에 눌린 스프링.", h1: "금리 인하, 바이오를 보라", intro: ["자금 조달 비용이 줄어드는 바이오와 중소형주가 가장 탄력적으로 반등할 것입니다."], sections: [{ h2: "배당주 매력", content: "채권 금리가 떨어지면 상대적으로 배당주의 매력이 부각됩니다." }], faq: [{ q: "빅테크는요?", a: "금리와 무관하게 실적으로 가지만, 밸류에이션 부담은 있습니다." }] },
        "us-election-impact": { commercialIntent: "mid", tags: ["forecast", "election"], title: "미국 대선 결과에 따른 주식 시장 시나리오", description: "트럼프 vs 바이든. 에너지, 방산, 친환경 섹터의 희비.", h1: "대선 테마주 미리보기", intro: ["공화당은 전통 에너지와 규제 완화, 민주당은 친환경 지원책을 선호합니다."], sections: [{ h2: "불확실성 해소", content: "누가 되느냐에 따라 산업 지형도가 바뀝니다. 누가 되든 불확실성이 해소되면 시장엔 호재입니다." }], faq: [{ q: "헬스케어는?", a: "약가 인하는 양당 공통 이슈라 항상 리스크가 있습니다." }] },
        "ai-bubble-check": { commercialIntent: "high", tags: ["forecast", "ai"], title: "AI 버블 논란: 닷컴 버블과 다른 점은?", description: "엔비디아 PER과 시스코 비교. 실체가 있는 성장인가 거품인가.", h1: "AI, 너무 비싼가?", intro: ["과거 닷컴 버블과 달리 지금의 빅테크는 막대한 현금 창출 능력을 증명하고 있습니다."], sections: [{ h2: "Capex 정점", content: "빅테크들의 AI 설비 투자가 꺾이는 시점이 반도체 고점이 될 것입니다." }], faq: [{ q: "추격 매수 해도 될까요?", a: "조정 시마다 분할 매수로 접근하는 것이 안전합니다." }] },
        "oil-price-2025": { commercialIntent: "mid", tags: ["forecast", "oil"], title: "2025 국제 유가(WTI) 전망과 에너지주", description: "OPEC+ 감산 vs 수요 둔화. 배당주로서의 엑슨모빌.", h1: "유가 80불 시대의 전략", intro: ["전쟁 등 지정학적 리스크가 하단을, 경기 둔화 우려가 상단을 막고 있습니다."], sections: [{ h2: "워렌 버핏의 선택", content: "버핏은 옥시덴탈을 계속 매수하며 유가 강세를 헷지하고 있습니다." }], faq: [{ q: "에너지주 지금 사도 되나요?", a: "고배당 매력이 있어 포트폴리오 헷지용으로 좋습니다." }] },
        "dollar-exchange-rate": { commercialIntent: "mid", tags: ["forecast", "forex"], title: "2025 달러 환율 전망: 강달러의 종말?", description: "미국 금리 인하와 원달러 환율 1300원 붕괴 가능성.", h1: "킹달러 힘 빠지나", intro: ["미국이 금리를 내리면 달러 약세 압력을 받습니다. 환차손에 대비해야 합니다."], sections: [{ h2: "환율 방어", content: "환 헤지(H) ETF를 활용하거나 원화 자산 비중을 늘리는 리밸런싱이 필요합니다." }], faq: [{ q: "환전 미룰까요?", a: "분할 환전이 답입니다. 환율 예측은 신의 영역입니다." }] },
        "recession-signal-sahm": { commercialIntent: "high", tags: ["forecast", "macro"], title: "경기 침체 신호: 샴의 법칙과 장단기 금리차", description: "실업률 상승이 보내는 경고. 경착륙(Hard Landing) 대비법.", h1: "침체의 전조 증상들", intro: ["실업률이 저점 대비 0.5%p 오르면(샴의 법칙) 침체가 시작된다는 통계가 있습니다."], sections: [{ h2: "역수익률 곡선", content: "장단기 금리 역전이 해소되는 시점에 보통 침체가 닥쳤습니다." }], faq: [{ q: "주식 다 팔아요?", a: "침체는 오히려 우량주를 싸게 살 기회이기도 합니다." }] },
        "next-big-thing-space": { commercialIntent: "mid", tags: ["forecast", "future"], title: "AI 다음 주도주는? 우주 항공과 로봇", description: "스페이스X, 테슬라 봇. 2030년을 이끌 차세대 테마.", h1: "지구를 떠나 우주로", intro: ["발사 비용 감소로 우주 산업이 현실화되고 있습니다. 로봇도 노동력 부족의 대안입니다."], sections: [{ h2: "관련 ETF", content: "ARKX(우주), BOTZ(로봇) 등이 있습니다." }], faq: [{ q: "실적이 있나요?", a: "아직은 기대감으로 오르는 단계라 변동성이 큽니다." }] },
        "emerging-market-flow": { commercialIntent: "low", tags: ["forecast", "emerging"], title: "신흥국 자금 이동 가속화 (인도, 멕시코)", description: "탈중국 공급망 재편. 프렌드쇼어링 수혜국 투자.", h1: "중국을 떠난 돈은 어디로?", intro: ["미국의 우방국이자 생산 기지 역할을 하는 멕시코, 인도로 투자가 쏠립니다."], sections: [{ h2: "원자재 수혜", content: "브라질 등 자원 부국도 인플레 시대에 주목받습니다." }], faq: [{ q: "환율 변동성은?", a: "신흥국 투자의 최대 리스크입니다." }] },
        "semiconductor-peak-out": { commercialIntent: "high", tags: ["forecast", "semicon"], title: "반도체 고점론(Peak Out) 분석", description: "HBM 수요는 견고한가? 레거시 반도체 재고와 AI 사이클.", h1: "반도체 슈퍼사이클의 끝은?", intro: ["AI 수요는 이제 시작이라는 시각과 스마트폰/PC 수요 둔화 우려가 공존합니다."], sections: [{ h2: "종목 차별화", content: "AI 관련주(엔비디아, 하이닉스)와 레거시(전통) 반도체 주가는 따로 갈 수 있습니다." }], faq: [{ q: "지금 진입은 늦었나요?", a: "조정 시 분할 매수는 유효하지만 몰빵은 위험한 구간입니다." }] },
        "bitcoin-halving-impact": { commercialIntent: "high", tags: ["forecast", "crypto"], title: "비트코인 반감기 이후 가격 전망", description: "공급 충격과 현물 ETF 수요. 10만 달러 돌파 시나리오.", h1: "반감기 효과는 유효한가", intro: ["채굴 보상이 줄어드는 반감기 이후에는 역사적으로 상승장이 왔습니다."], sections: [{ h2: "기관 자금 유입", content: "ETF 승인으로 기관 자금이 들어오며 변동성이 줄고 우상향할 가능성이 높습니다." }], faq: [{ q: "이더리움은요?", a: "비트코인을 따라가되 변동성은 더 클 것입니다." }] },
        "real-estate-commercial-risk": { commercialIntent: "high", tags: ["forecast", "risk"], title: "미국 상업용 부동산(CRE) 위기와 은행주", description: "오피스 공실률 역대 최고. 지역 은행 파산 리스크 점검.", h1: "부동산발 금융 위기 가능성", intro: ["재택근무 정착으로 오피스 가치가 폭락했습니다. 대출해준 은행들의 건전성이 우려됩니다."], sections: [{ h2: "선별 투자", content: "KBR, NYCB 등 상업용 부동산 노출도가 높은 지역 은행 투자는 피해야 합니다." }], faq: [{ q: "리츠도 위험한가요?", a: "오피스 리츠는 직격탄을 맞았지만 보관 창고, 데이터센터 등은 안전합니다." }] }
    }
};
